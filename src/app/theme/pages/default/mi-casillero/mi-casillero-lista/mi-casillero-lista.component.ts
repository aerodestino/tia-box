...
export class MiCasilleroListaComponent extends BaseListComponent implements OnInit {
    usuario: any;
    enBodega: any[];
    enTransito: any[];
    facturacion: any[];
    ...
    getEnBodega() {
        ...
        this.articulosService.getPorEstado(this.enBodegaFilters).subscribe(articulos => {
            this.enBodega = articulos.json().data.results;
            this.totalEnBodega = articulos.json().data.paging.total;
            console.log("en bodega", this.enBodega);
        }, error => {
            this.toastr.error(error.json().error.message);
        });
    }
    ...
    getEnTransito() {
        ...
        this.articulosService.getPorEstado(this.enTransitoFilters).subscribe(articulos => {
            this.enTransito = articulos.json().data.results;
            this.totalEnTransito = articulos.json().data.paging.total;
            console.log("en transito", this.enTransito);
        }, error => {
            this.toastr.error(error.json().error.message);
        });
    }
    ...
    getFacturacion() {
        ...
        this.articulosService.getPorEstado(this.facturacionFilters).subscribe(articulos => {
    ...
    getRutaNacional() {
        ...
        this.articulosService.getPorEstado(this.rutaNacionalFilters).subscribe(articulos => {
            this.rutaNacional = articulos.json().data.results;
            this.totalRutaNacional = articulos.json().data.paging.total;
            console.log("ruta nacional", this.rutaNacional);
        }, error => {
            this.toastr.error(error.json().error.message);
        });
    }
    ...
    getEntregados() {
        ...
        this.articulosService.getPorEstado(this.entregadosFilters).subscribe(articulos => {
            this.entregados = articulos.json().data.results;
            this.totalEntregados = articulos.json().data.paging.total;
            console.log("entregados", this.entregados);
    ...
    onSubirFactura(articulo) {
        ...
        formData.append('factura', articulo.facturaExcel, articulo.facturaExcel.name);
    ...
    onConsolidar() {
        Helpers.setLoading(true);
        this.articulosService.consolidar({ articulos: this.enBodegaSeleccion }).subscribe(() => {
            Helpers.setLoading(false);
    ...
    onEmbarcar() {
        Helpers.setLoading(true);
        this.articulosService.embarcar({ articulos: this.enBodegaSeleccion }).subscribe(() => {
            Helpers.setLoading(false);
